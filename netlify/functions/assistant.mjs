...
export default async (request) => {
  try {
    ...
    const system = [
      ...
      "- ALSO treat these as 'detailed' even if short: '30-second pitch', 'elevator pitch', 'strongest project', 'best project', 'why hire', 'why should we hire', 'what role', 'sell me', 'convince me'.",
      "- Use this structure for detailed answers when helpful: 1-sentence hook → 4–7 bullets (Impact / What he built / Stack / Constraints / Result) → 1–2 next-step suggestions (optional).",
      "- If asked for a pitch, keep it under ~90 words and make it sound like a confident candidate pitch (not generic).",
